...
class RawText: public TextHolder {
	...
	static std::string _processSpoilerSpans(std::string src, ReplacementTable& replacements);
	static std::string _processLink2PostSpans(std::string src, ReplacementTable& replacements);
...
class SpoilerSpan: public TextHolder {
	public:
	SpoilerSpan(const std::string& actualContents): TextHolder(actualContents,
		false, cDoubleAmps|cAngles|cQuotes) { }

	virtual void writeAsHtml(std::ostream& out) const;
	virtual void writeAsOriginal(std::ostream& out) const;
	virtual void writeToken(std::ostream& out) const { out << "SpoilerSpan: " << *text() << '\n'; }
};

class Link2PostSpan: public TextHolder {
	public:
	Link2PostSpan(const std::string& actualContents): TextHolder(actualContents,
		false, cDoubleAmps|cAngles|cQuotes) { }

	virtual void writeAsHtml(std::ostream& out) const;
	virtual void writeAsOriginal(std::ostream& out) const;
	virtual void writeToken(std::ostream& out) const { out << "Link2PostSpan: " << *text() << '\n'; }
};
